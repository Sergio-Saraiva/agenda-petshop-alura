      ...
      <Mutation mutation={ADICIONAR_PET}>
        {
          ...
          return <form onSubmit={this.gerenciarEnvio.bind(this, adicionarPet)}>
          <div>
          ...
          <div>
            ...
            <input type="number" name="donoId" id="donoId" value={this.state.donoId} onChange={this.gerenciarMudancas} />
          </div>
          <div>
